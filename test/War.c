...
void selecionarEAtacar(struct territorio* mapa, int totalTerritorios) {
    ...
    for (int i = 0; i < totalTerritorios; i++) {
        if (mapa[i].tropas >= 2)
            printf("  [%d] %-15s | Cor: %-10s | Tropas: %d ⚔️  <- PODE ATACAR\n",
    ...
    if (mapa[idxAtacante].tropas < 2) {
        printf("\n❌ Este territorio nao possui tropas suficientes para atacar!\n");
        return;
    }
    ...
    for (int i = 0; i < totalTerritorios; i++) {
        if (i != idxAtacante) {
            printf("  [%d] %-15s | Cor: %-10s | Tropas: %d 🛡️\n",
                   i+1, mapa[i].nome, mapa[i].cor, mapa[i].tropas);
        }
    }
    ...
    do {
        ...
        switch(opcao) {
            ...
            case 1:
                ...
                // ====================================================
                // EXEMPLO DE ALTERAÇÃO PARA TESTAR MISSÃO
                // ====================================================
